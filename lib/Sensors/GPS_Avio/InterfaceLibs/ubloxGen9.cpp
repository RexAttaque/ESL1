...
class ublox_gen9 {
  ...
  private:
    ...
    uint16_t GPS_TimeToRefresh;
    uint8_t GPS_NavRate;

    uint8_t GPS_PltfrmModel;

    long GPS_default_Baudrate;
    long GPS_Baudrate;
    uint8_t GPS_StopBits;
    
    bool UART1_NMEA;
    bool USB_NMEA;

    bool bufferedPOSECEF;
...
//      }
    ...
    //  Serial.println("");
      ...
      return setConfig(configLevel, CFG_NAVSPG_DYNMODEL, GPS_PltfrmModel, 1);
    }
