...
:Base_Sensor(BMP280_const::BARO_Avio_varAmount, BMP280_const::default_BARO_BMP280_Hz, BMP280_const::debug_ID, BMP280_const::debug_lvl),_address(address),BARO(Adafruit_BMP280(i2c_bus)),_over_samp_T(over_samp_T),_over_samp_P(over_samp_P),_filter(filter),_stb_time(stb_time),_mode(mode)
{}
